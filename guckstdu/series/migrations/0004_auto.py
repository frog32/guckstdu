...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field fans on 'Series'
        db.create_table('series_series_fans', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('series', models.ForeignKey(orm['series.series'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('series_series_fans', ['series_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field fans on 'Series'
        db.delete_table('series_series_fans')
    ...
    models = {
        ...
        'series.series': {
            ...
            'fans': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'favourite_series'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'series.station': {
